...
const writerKnowledgeSchema = mongoose.Schema(
  {
    questionNumber: {
      type: Number,
    ...
    questionType: {
      ...
      enum: {
        ...
        message:
          "QuestionType should be Single, MultipleChoice, Form, YES/NO only.",
      },
    },
    questionText: {
      type: String,
...
module.exports = mongoose.model("writerknowledge", writerKnowledgeSchema);
